...
void f3(int *p  _Byte_count(len * sizeof(int)), int len) {
}
...
void f1_complete_arr(int a[10]  _Itype(int checked[10])) {
}

void f2_complete_arr(int p[10]  _Count(10)) {
}

void f3_complete_arr(int p[10]  _Byte_count(10 * sizeof(int))) {
}

void f4_complete_arr(int p[10]  _Bounds(p, p + 10)) {
}

void f1_incomplete_arr(int a[]  _Itype(int checked[])) {
}

void f2_incomplete_arr(int p[]  _Count(len), int len) {
}

void f3_incomplete_arr(int p[]  _Byte_count(len * sizeof(int)), int len) {
}
...
void f1_complete_md_arr(int a[10][10]  _Itype(int checked[10][10])) {
}

void f2_complete_md_arr(int p[10][10]  _Count(10)) {
}

void f3_complete_md_arr(int p[10][10]  _Byte_count(10 * sizeof(int [10]))) {
}

void f4_complete_md_arr(int p[10][10]  _Bounds(p, p + 10)) {
}

void f1_incomplete_md_arr(int a[][10]  _Itype(int checked[][10])) {
}

void f2_incomplete_md_arr(int p[][10]  _Count(len), int len) {
}

void f3_incomplete_md_arr(int p[][10]  _Byte_count(len * sizeof(int[10])), int len) {
}
...
void f3_void(void *p  _Byte_count(len * sizeof(int)), int len) {
}
...
void g2_incomplete_array_param(int ap checked[]  _Count(len), int len) {
  f1_incomplete_arr(ap);
  f2_incomplete_arr(ap, len);
  f3_incomplete_arr(ap, len);
  f4_incomplete_arr(ap, len);
...
typedef int(*callback_fn2) (int *a  _Itype(int checked[10]));
...
typedef int(*callback_fn3) (int(*a)[10]  _Itype(int checked[10][10]));
