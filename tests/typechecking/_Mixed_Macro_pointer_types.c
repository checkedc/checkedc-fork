...
void check_nullterm_restrictions(void) {
  ...
  nt_array_ptr<int* _Single> t2 = 0;         // pointer types are OK.
...
extern void check_assign(int val, int *p, ptr<int> q, int* _Array r,
    ...
    ptr<int* _Single> checked_ptr_to_checked_ptr = &q;
    array_ptr<int* _Single> array_ptr_to_checked_ptr = &q;
...
check_assign_void_checked(int val, int* _Single p,
    ...
    array_ptr<struct CheckedData1> t23 = r2;  // expected-error {{not allowed in a checked scope}}
                                          ...
                                          // a checked pointer
    ptr<int* _Single> t24 = r3; // expected-error {{not allowed in a checked scope}}
                            // array_ptr<T> = void* _Array where T contains
                            // a checked pointer
    ptr<int* _Single> t25 checked[1]= r3;  // expected-error{{array initializer must be an initializer list}}
                                         // array_ptr<T> = void* _Array where T contains
                                         // a checked pointer
    // conversions between integers and safe void pointers.
...
check_assign_void_checked_bounds_only(int val, int* _Single p,
    ...
    struct CheckedData1 * _Array t23 = r2;  // array_ptr<T> = void* _Array OK where T contains
                                              // a checked pointer
    ptr<int* _Single> t24 = r3; // array_ptr<T> = void* _Array OK where T contains
                            // a checked pointer
    // conversions between integers and safe void pointers.
