...
extern void count_exprs(void) {
  ...
  array_ptr<int> t1  _Count(c1) = 0;
  array_ptr<int> t2  _Count(c2) = 0;
  array_ptr<int> t3  _Count(c3) = 0;
  array_ptr<int> t4  _Count(c4) = 0;
  array_ptr<int> t5  _Count(c5) = 0;
  array_ptr<int> t6  _Count(c6) = 0;
  array_ptr<int> t7  _Count(c7) = 0;
  array_ptr<int> t8  _Count(c8) = 0;
  array_ptr<int> t9  _Count(c9) = 0;
  array_ptr<int> t10  _Count(c10) = 0;
  array_ptr<int> t11  _Count(c11) = 0;
  // Spot-check type checking of count expressions involving file-scoped
  // variables.
  array_ptr<int> t12  _Count(A) = 0;
  array_ptr<int> t13  _Count(B) = 0;
  array_ptr<int> t14  _Count(12) = 0;
  ...
  array_ptr<int> t15  _Count(-5) =  0;

  array_ptr<int> t16  _Byte_count(c1) = 0;
  array_ptr<int> t17  _Byte_count(c2) = 0;
  array_ptr<int> t18  _Byte_count(c3) = 0;
  array_ptr<int> t19  _Byte_count(c4) = 0;
  array_ptr<int> t20  _Byte_count(c5) = 0;
  array_ptr<int> t21  _Byte_count(c6) = 0;
  array_ptr<int> t22  _Byte_count(c7) = 0;
  array_ptr<int> t23  _Byte_count(c8) = 0;
  array_ptr<int> t24  _Byte_count(c9) = 0;
  array_ptr<int> t25  _Byte_count(c10) = 0;
  array_ptr<int> t26  _Byte_count(c11) = 0;
  // Spot-check type checking of byte_count expressions involving file-scoped
  // variables.
  array_ptr<int> t27  _Byte_count(A) = 0;
  array_ptr<int> t28  _Byte_count(B) = 0;
  array_ptr<int> t29  _Byte_count(12) = 0;
  // This will eventually fail static checking of bounds declarations, at which
  // point we'll need to add an expected error message.
  array_ptr<int> t30  _Byte_count(-8) = 0;
...
extern void invalid_count_exprs(void) {
 ...
 float _Complex c8 = 8.0;
  ...
  array_ptr<int> t1  _Count(c1) = 0;   // expected-error {{invalid argument type 'float' to count expression}}
  array_ptr<int> t2  _Count(c2) = 0;   // expected-error {{invalid argument type}}
  array_ptr<int> t3  _Count(c3) = 0;   // expected-error {{invalid argument type}}
  array_ptr<int> t4  _Count(c4) = 0;   // expected-error {{invalid argument type}}
  array_ptr<int> t5  _Count(c5) = 0;   // expected-error {{invalid argument type}}
  array_ptr<int> t6  _Count(c6) = 0;   // expected-error {{invalid argument type}}
  array_ptr<int> t7  _Count(c7) = 0;   // expected-error {{invalid argument type}}
  array_ptr<int> t8  _Count(s.f) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t9  _Count(test_func) = 0; // expected-error {{invalid argument type}}
  array_ptr<int> t10  _Count(func_ptr) = 0; // expected-error {{invalid argument type}}
  array_ptr<int> t11  _Count("test") = 0; // expected-error {{invalid argument type}}
  array_ptr<int> t12  _Count(5.0f) = 0; // expected-error {{invalid argument type}}
  array_ptr<int> t13  _Count(globalFloat) = 0; // expected-error {{invalid argument type}}

#ifndef __STDC_NO_COMPLEX__
  array_ptr<int> t14  _Count(c8) = 0;   // expected-error {{invalid argument type}}
#endif

  array_ptr<int> t15  _Byte_count(c1) = 0;  // expected-error {{invalid argument type 'float' to byte_count expression}}
  array_ptr<int> t16  _Byte_count(c2) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t17  _Byte_count(c3) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t18  _Byte_count(c4) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t19  _Byte_count(c5) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t20  _Byte_count(c6) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t21  _Byte_count(c7) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t22  _Byte_count(s.f) = 0; // expected-error {{invalid argument type}}
  array_ptr<int> t23  _Byte_count(func_ptr) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t24  _Byte_count("test") = 0; // expected-error {{invalid argument type}}
  array_ptr<int> t25  _Byte_count(5.0f) = 0; // expected-error {{invalid argument type}}
  array_ptr<int> t26  _Byte_count(globalFloat) = 0; // expected-error {{invalid argument type}}

#ifndef __STDC_NO_COMPLEX__
  array_ptr<int> t27  _Byte_count(c8) = 0;   // expected-error {{invalid argument type}}
#endif
...
extern void bounds_exprs(void) {
  int i[3] = { 0, 1, 0 };
   ...
   array_ptr<int> t1  _Bounds(array_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t2  _Bounds(ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t3  _Bounds(array_ptr_lb, ptr_ub) = i;
   array_ptr<int> t4  _Bounds(unchecked_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t5  _Bounds(array_ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t6  _Bounds(ptr_lb, ptr_ub) = i;
   array_ptr<int> t7  _Bounds(unchecked_ptr_lb, ptr_ub) = i;
   array_ptr<int> t8  _Bounds(ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t9  _Bounds(unchecked_ptr_lb, unchecked_ptr_ub) = i;

   // spot check mixed uses of nt_array_ptr and other pointer types.
   array_ptr<int> t9a  _Bounds(nt_array_ptr_lb, ptr_ub) = i;
   array_ptr<int> t9b  _Bounds(array_ptr_lb, nt_array_ptr_ub) = i;
   array_ptr<int> t9c  _Bounds(ptr_lb, array_ptr_ub) = i;

   // use an array-typed value as the lower bound.  This value
   // should be converted implicitly to be a pointer type.

   array_ptr<int> t10  _Bounds(i, i + 1) = i;
   array_ptr<int> t11  _Bounds(i, array_ptr_ub) = i;
   array_ptr<int> t11a  _Bounds(i, nt_array_ptr_ub) = i;
   array_ptr<int> t13  _Bounds(i, ptr_ub) = i;
   ...
   array_ptr<int> t21  _Bounds(void_array_ptr_lb, void_array_ptr_ub) = i;
   array_ptr<int> t22  _Bounds(void_ptr_lb, void_array_ptr_ub) = i;
   array_ptr<int> t23  _Bounds(void_array_ptr_lb, void_ptr_ub) = i;
   array_ptr<int> t24  _Bounds(void_unchecked_ptr_lb, void_array_ptr_ub) = i;
   array_ptr<int> t25  _Bounds(void_array_ptr_lb, void_unchecked_ptr_ub) = i;
   array_ptr<int> t26  _Bounds(void_ptr_lb, void_ptr_ub) = i;
   array_ptr<int> t27  _Bounds(void_unchecked_ptr_lb, void_ptr_ub) = i;
   array_ptr<int> t28  _Bounds(void_ptr_lb, void_unchecked_ptr_ub) = i;
   array_ptr<int> t29  _Bounds(void_unchecked_ptr_lb, void_unchecked_ptr_ub) = i;

   // check combinations of pointers to void and pointers to non-void types

   array_ptr<int> t42  _Bounds(array_ptr_lb, void_array_ptr_ub) = i;
   array_ptr<int> t43  _Bounds(ptr_lb, void_array_ptr_ub) = i;
   array_ptr<int> t44  _Bounds(void_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t45  _Bounds(void_array_ptr_lb, ptr_ub) = i;
   array_ptr<int> t46  _Bounds(array_ptr_lb, void_ptr_ub) = i;
   array_ptr<int> t47  _Bounds(unchecked_ptr_lb, void_array_ptr_ub) = i;
   array_ptr<int> t48  _Bounds(void_unchecked_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t49  _Bounds(void_array_ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t50  _Bounds(array_ptr_lb, void_unchecked_ptr_ub) = i;

   array_ptr<int> t51  _Bounds(void_ptr_lb, ptr_ub) = i;
   array_ptr<int> t52  _Bounds(ptr_lb, void_ptr_ub) = i;
   array_ptr<int> t53  _Bounds(unchecked_ptr_lb, void_ptr_ub) = i;
   array_ptr<int> t54  _Bounds(void_unchecked_ptr_lb, ptr_ub) = i;
   array_ptr<int> t55  _Bounds(void_ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t56  _Bounds(ptr_lb, void_unchecked_ptr_ub) = i;

   // spot check mixed uses of pointers to void and null-terminated pointers
   array_ptr<int> t60  _Bounds(void_array_ptr_lb, nt_array_ptr_ub) = i;
   array_ptr<int> t61  _Bounds(nt_array_ptr_lb, void_ptr_ub) = i;
   ...
   array_ptr<int> t91  _Bounds(typedef_array_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t92  _Bounds(ptr_lb, typedef_array_ptr_ub) = i;
   array_ptr<int> t93  _Bounds(array_ptr_lb, typedef_ptr_ub) = i;
   array_ptr<int> t94  _Bounds(typedef_unchecked_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t95  _Bounds(typedef_array_ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t96  _Bounds(typedef_ptr_lb, ptr_ub) = i;
   array_ptr<int> t97  _Bounds(unchecked_ptr_lb, typedef_ptr_ub) = i;
   array_ptr<int> t98  _Bounds(ptr_lb, typedef_unchecked_ptr_ub) = i;
   array_ptr<int> t99  _Bounds(typedef_unchecked_ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t100  _Bounds(typedef_nt_array_ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t101  _Bounds(typedef_array_ptr_lb, typedef_nt_array_ptr_ub) = i;
   ...
   array_ptr<int> t121  _Bounds(array_ptr_const_lb, array_ptr_ub) = i;
   array_ptr<int> t122  _Bounds(const_array_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t123  _Bounds(const_array_ptr_const_lb, array_ptr_ub) = i;

   array_ptr<int> t124  _Bounds(array_ptr_lb, array_ptr_const_ub) = i;
   array_ptr<int> t125  _Bounds(array_ptr_lb, const_array_ptr_ub) = i;
   array_ptr<int> t126  _Bounds(array_ptr_lb, const_array_ptr_const_ub) = i;

   array_ptr<int> t127  _Bounds(const_array_ptr_lb, array_ptr_const_ub) = i;
   array_ptr<int> t128  _Bounds(array_ptr_const_lb, const_array_ptr_ub) = i;
   array_ptr<int> t129  _Bounds(const_array_ptr_const_lb, const_array_ptr_const_ub) = i;

   array_ptr<int> t130  _Bounds(ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t131  _Bounds(array_ptr_lb, ptr_ub) = i;
   array_ptr<int> t132  _Bounds(unchecked_ptr_lb, array_ptr_ub) = i;
   array_ptr<int> t133  _Bounds(array_ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t134  _Bounds(ptr_lb, ptr_ub) = i;
   array_ptr<int> t135  _Bounds(unchecked_ptr_lb, ptr_ub) = i;
   array_ptr<int> t136  _Bounds(ptr_lb, unchecked_ptr_ub) = i;
   array_ptr<int> t137  _Bounds(unchecked_ptr_lb, unchecked_ptr_ub) = i;

   // spot check const nt_array_ptr
   array_ptr<int> t140  _Bounds(nt_array_ptr_lb, const_nt_array_ptr_ub) = i;
   array_ptr<int> t141  _Bounds(const_nt_array_ptr_lb, nt_array_ptr_ub) = i;
 }
 ...
 extern void invalid_bounds_exprs(void) {
   ...
   array_ptr<int> t1  _Bounds(c1, c1) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t2  _Bounds(c2, c2) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t3  _Bounds(c3, c3) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t4  _Bounds(c4, c4) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t5  _Bounds(c5, c5) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t6  _Bounds(c6, c6) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t7  _Bounds(c7, c7) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t8  _Bounds(c8, c8) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t9  _Bounds(c9, c9) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t10  _Bounds(c10, c10) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t11  _Bounds(c11, c11) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t12  _Bounds(c12, c12) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t13  _Bounds(c13, c13) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t14  _Bounds(c14, c14) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t15  _Bounds(c15, c15) = 0; // expected-error 2 {{expected expression with pointer type}}
   array_ptr<int> t16  _Bounds(test_func, test_func) = 0; // expected-error 2 {{invalid argument type 'void (*)(void)' to bounds expression}}

   // have values with different levels of indirection
   array_ptr<int> t17  _Bounds(double_indir, c3) = 0; // expected-error {{expected expression with pointer type}}
   array_ptr<int> t18  _Bounds(double_indir, single_indir) = 0; // expected-error {{pointer type mismatch}}

   // test mismatched bounds expression types
   int i[2];
   array_ptr<int> int_array_ptr_lb = i;
   array_ptr<int> int_array_ptr_ub = i + 1;
   ...
   array_ptr<int> t20  _Bounds(int_array_ptr_lb, char_array_ptr_ub) = i;     // expected-error {{pointer type mismatch}}
   array_ptr<int> t21  _Bounds(int_ptr_lb, char_array_ptr_ub) = i;           // expected-error {{pointer type mismatch}}
   array_ptr<int> t22  _Bounds(int_unchecked_ptr_lb, char_array_ptr_ub) = i; // expected-error {{pointer type mismatch}}
   ...
   array_ptr<int> t30  _Bounds(int_array_ptr_lb, char_ptr_ub) = i;     // expected-error {{pointer type mismatch}}
   array_ptr<int> t31  _Bounds(int_ptr_lb, char_ptr_ub) = i;           // expected-error {{pointer type mismatch}}
   array_ptr<int> t32  _Bounds(int_unchecked_ptr_lb, char_ptr_ub) = i; // expected-error {{pointer type mismatch}}
...
// byte_count
array_ptr<int> g4  _Byte_count(5 * sizeof(int)) = 0;
...
// bounds
array_ptr<int> g10  _Bounds(g10, g10 + 5) = 0;
...
{
  // count
  array_ptr<int> t1  _Count(5) = 0;
  int t3 checked[5]  _Count(5);
  int t3a nt_checked[5]  _Count(4);

  // byte_count
  array_ptr<int> t4  _Byte_count(5 * sizeof(int)) = 0;
  ...
  // bounds
  array_ptr<int> t10  _Bounds(t10, t10 + 5) = 0;
...
void param_var_bounds_decl(
  ...
  // byte_count
  array_ptr<int> t4  _Byte_count(5 * sizeof(int)),
  ...
  // bounds
  array_ptr<int> t10  _Bounds(t10, t10 + 5),
  // The use of 't3' is intentional - pointer arithmetic is not
  // allowed on pointers to void types.
...
extern void anonymous_param_var_bounds_decl(
  ...
  // byte_count
  array_ptr<int>  _Byte_count(5 * sizeof(int)),
  ...
  // bounds
  array_ptr<int>  _Bounds(garr, garr + 5),
...
// byte_count
struct S4 {
  array_ptr<int> f4  _Byte_count(5 * sizeof(int));
...
// bounds
struct S6 {
  array_ptr<int> f10  _Bounds(f10, f10 + 5);
...
// bounds
array_ptr<int> fn10(void)  _Bounds(s1, s1 + 5) { return 0; }
...
// tests.
void fn100(array_ptr<int> p1  _Count(5));
void fn100a(array_ptr<int> p1  _Count(6));
...
int fn103(array_ptr<int> p1  _Byte_count(5 * sizeof(int)));
int fn103a(array_ptr<int> p1  _Byte_count(7 * sizeof(int)));
...
void fn108(array_ptr<int> p1  _Bounds(p1, p1 + 5));
void fn108a(int* _Nt_array p1  _Bounds(p1, p1 + 5));
void fn109(array_ptr<int> p1, int p2  _Bounds(p1, p1 + 5));
void fn110(array_ptr<int> p1, float p2  _Bounds(p1, p1 + 5)); // expected-error {{expected 'p2' to have a pointer, array, or integer type}}
void fn111(void* _Array p1  _Bounds((char *)p1, (char *)p1 + (5 * sizeof(int))));

// A few functions with multiple arguments.
void fn120(array_ptr<int> mid  _Bounds(p1, p1 + 5), array_ptr<int> p1);
...
void fn200(void (*fnptr)(array_ptr<int> p1  _Count(5)));
...
void fn203(int (*fnptr)(array_ptr<int> p1  _Byte_count(5 * sizeof(int))));
...
void fn208(void (*fnptr)(array_ptr<int> p1  _Bounds(p1, p1 + 5)));
void fn208a(void(*fnptr)(int* _Nt_array p1  _Bounds(p1, p1 + 5)));
void fn209(void (*fnptr)(array_ptr<int> p1, int p2  _Bounds(p1, p1 + 5)));
void fn210(void (*fnptr)(array_ptr<int> p1, float p2  _Bounds(p1, p1 + 5))); // expected-error {{expected 'p2' to have a pointer, array, or integer type}}
void fn211(void (*fnptr)(void* _Array p1  _Bounds((char *) p1, (char *) p1 + (5 * sizeof(int)))));

// Checked function pointers
void fn220(ptr<void (array_ptr<int> p1  _Count(5))> fnptr);
...
void fn223(ptr<int (array_ptr<int> p1  _Byte_count(5 * sizeof(int)))> fnptr);
...
void fn228(ptr<void (array_ptr<int> p1  _Bounds(p1, p1 + 5))> fnptr);
void fn229(ptr<void (array_ptr<int> p1, int p2  _Bounds(p1, p1 + 5))> fnptr);
void fn230(ptr<void (array_ptr<int> p1, float p2  _Bounds(p1, p1 + 5))> fnptr); // expected-error {{expected 'p2' to have a pointer, array, or integer type}}
void fn231(ptr<void (void* _Array p1  _Bounds((char *)p1, (char *)p1 + (5 * sizeof(int))))> fnptr);

// Function pointers with multiple arguments.
void fn240(ptr<int (array_ptr<int> mid  _Bounds(p1, p1 + 5), array_ptr<int> p1)> fnptr);
...
void fn260(array_ptr<int> (*fnptr)(void)  _Count(5));
void fn261(array_ptr<int>(*fnptr)(int i)  _Count(i));
...
void function_pointers(void) {
  ...
  array_ptr<int>(*t1)(void)  _Count(5) = fn1;
  ...
  array_ptr<int>(*t8)(void)  _Byte_count(5 * sizeof(int)) = fn4;
  ...
  array_ptr<int>(*t13)(void)  _Bounds(s1, s1 + 5) = fn10;
  ...
  // function.
  ptr<array_ptr<int>(void)  _Count(5)> t100 = fn1;
  // The reverse is not allowed
  array_ptr<int>(*t101)(void)  _Count(5) = t100; // expected-error {{incompatible type}}
...
void invalid_function_pointers(void) {
  array_ptr<int>(*t1)(void)  _Count(4) = fn1;  // expected-error {{incompatible type}}
  ptr<array_ptr<int>(void)  _Count(4)> t1a = fn1;  // expected-error {{incompatible type}}
  array_ptr<int>(*t4)(void)  _Byte_count(6 * sizeof(int)) = fn4; // expected-error {{incompatible type}}
  array_ptr<int>(*t10)(void)  _Bounds(s1, s1 + 4) = fn10; // expected-error {{incompatible type}}
}
...
array_ptr<int> f301(void)  _Bounds(return_value, return_value + 10);
array_ptr<int> f302(void)  _Bounds(return_value - 5, return_value + 5);
array_ptr<int> f303(void)  _Count(return_value); // expected-error {{invalid argument type}}
array_ptr<int> f304(void)  _Bounds(arr, arr + (return_value << 5)); // expected-error {{invalid operands to binary expression}}
