...
extern void check_assign(int val, int p[10], int q[], int r checked[10], int s checked[],
  ...
  int* _Array t11a = u;
  int* _Array t12 = u;
  int* _Nt_array t12a = x;
  int* _Nt_array t12b = u;      // expected-error {{expression of incompatible type 'int _Checked[10]'}}
  int* _Array t13 = s2d[0];
  int* _Array t13a = w2d[0];
  int* _Nt_array t13b _Bounds(unknown) = w2d[0];
  int* _Nt_array t13c = s2d[0]; // expected-error {{expression of incompatible type 'int _Checked[10]'}}
  int* _Array t14 = t2d[0];
  int* _Array t15 = u2d[0];
  int* _Array t15a = x2d[0];
...
extern void check_condexpr(int val) {
  ...
  int* _Nt_array t2b = val ? p : v; // expected-error {{incompatible type}}
                                       ...
                                       // only array_ptr.
  int* _Array t3 = val ? r : p;  // T checked[N] and T[M] OK
  int* _Array t3a = val ? v : p; // T nt_checked[N] and T[M] OK.
  int* _Nt_array t3b = val ? v : p; // expected-error {{incompatible type}}
                                       // But they produce only array_ptr.
  int* _Array t4 = val ? r : r;  // T checked[N] and T checked[M] OK.
  int* _Array t4a = val ? r : v;  // T checked[N] and T nt_checked[M] OK.
  int* _Array t4b = val ? v : r;  // T nt_checked[N] and T checked[M] OK.
  int* _Nt_array t4c = val ? r : v;  // expected-error {{incompatible type}}
                                        // But they produce only array_ptr.
  int* _Nt_array t4d = val ? v : r;  // expected-error {{incompatible type}}
                                        // But they produce only array_ptr
...
extern void check_condexpr_cv(void)
{
  ...
  array_ptr<const int> t27 = val ? p_const : r;       // const int * and int* _Array OK
  array_ptr<const int> t28 = val ? r : p_const;       // int* _Array and const int * OK
  ...
  array_ptr<const int> t31 = val ? r : r_const;       // int* _Array and array_ptr<const int> OK
  array_ptr<const int> t32 = val ? r_const : r;       // array_ptr<const int> and int* _Array OK
  ...
  array_ptr<const int> t27a = val ? p_const : s;       // const int * and int* _Nt_array OK
  array_ptr<const int> t28a = val ? s : p_const;       // int* _Nt_array and const int * OK
  ...
  array_ptr<const int> t31a = val ? s : r_const;       // int* _Nt_array and array_ptr<const int> OK
  array_ptr<const int> t32a = val ? r_const : s;       // array_ptr<const int> and int* _Nt_array OK
  ...
  array_ptr<const int> t33c = val ? s : s_const;       // int* _Nt_array and nt_array_ptr<const int> OK
  array_ptr<const int> t33d = val ? s_const : s;       // nt_array_ptr<const int> and int* _Nt_array OK
  ...
  int* _Array t36 = val ? p_const : r;   // expected-warning {{discards qualifiers}}
                                            // const int * and int* _Array produce array_ptr<const int>
  int* _Array t37 = val ? r : p_const;   // expected-warning {{discards qualifiers}}
                                            // int* _Array and const int * produce array_ptr<const int>
  ...
  int* _Array t40 = val ? r : r_const;   // expected-warning {{discards qualifiers}}
                                            // int* _Array and array_ptr<const int> produce array_ptr<const int>
  int* _Array t41 = val ? r_const : r;   // expected-warning {{discards qualifiers}}
                                            // array_ptr<const int> and int* _Array produce array_ptr<const int>
  ...
  int* _Array t34a = val ? p : s_const;  // expected-warning {{discards qualifiers}}
                                            // int * and nt_array_ptr<const int> produce array_ptr<const int>
  int* _Array t35a = val ? s_const : p;  // expected-warning {{discards qualifiers}}
                                            // nt_array_ptr<const int> and int * produce array_ptr<const int>
  int* _Array t36a = val ? p_const : s;  // expected-warning {{discards qualifiers}}
                                            // const int * and int* _Nt_array produce array_ptr<const int>
  int* _Array t37a= val ? s : p_const;   // expected-warning {{discards qualifiers}}
                                            // int* _Nt_array and const int * produce array_ptr<const int>
  int* _Array t38a = val ? p_const : s_const;  // expected-warning {{discards qualifiers}}
                                                  // const int * and nt_array_ptr<const int> produce array_ptr<const int>
  int* _Array t39a = val ? s_const : p_const;  // expected-warning {{discards qualifiers}}
                                                  // nt_array_ptr<const int> and const int * produce array_ptr<const int>
  int* _Array t40a = val ? s : r_const;  // expected-warning {{discards qualifiers}}
                                            // int* _Nt_array and array_ptr<const int> produce array_ptr<const int>
  int* _Array t41a = val ? r_const : s;  // expected-warning {{discards qualifiers}}
                                            // array_ptr<const int> and int* _Nt_array produce array_ptr<const int>
  int* _Array t42a = val ? r_const : s_const;  // expected-warning {{discards qualifiers}}
                                                  // array_ptr<const int> and nt_array_ptr<const int> produce array_ptr<const int>
  int* _Array t43a = val ? s_const : r_const;  // expected-warning {{discards qualifiers}}
                                                  // nt_array_ptr<const int> and array_ptr<const int> produce array_ptr<const int>
  int* _Array t43b = val ? r_const : s_const; // expected-warning {{discards qualifiers}}
                                                 // array_ptr<const int> and nt_array_ptr<const int> produce array_ptr<const int>
  int* _Array t43c = val ? s : s_const;       // expected-warning {{discards qualifiers}}
                                                 // int* _Nt_array and nt_array_ptr<const int> produce array_ptr<const int>
  int* _Array t43d = val ? s_const : s;       // expected-warning {{discards qualifiers}}
                                                 // nt_array_ptr<const int> and int* _Nt_array produce array_ptr<const int>
  ...
  array_ptr<volatile int> t76 = val ? p_volatile : r;          // volatile int * and int* _Array OK
  array_ptr<volatile int> t77 = val ? r : p_volatile;          // int* _Array and volatile int * OK
  ...
  array_ptr<volatile int> t80 = val ? r : r_volatile;          // int* _Array and array_ptr<volatile int> OK
  array_ptr<volatile int> t81 = val ? r_volatile : r;          // array_ptr<volatile int> and int* _Array OK
  ...
  array_ptr<volatile int> t76a = val ? p_volatile : s;          // volatile int * and int* _Nt_array OK
  array_ptr<volatile int> t77a = val ? s : p_volatile;          // int* _Nt_array and volatile int * OK
  ...
  array_ptr<volatile int> t80a = val ? s : r_volatile;          // int* _Nt_array and nt_array_ptr<volatile int> OK
  array_ptr<volatile int> t81a = val ? r_volatile : s;          // nt_array_ptr<volatile int> and int* _Nt_array OK
  ...
  array_ptr<volatile int> t82c = val ? s : s_volatile;          // int* _Nt_array and nt_array_ptr<volatile int> OK
  array_ptr<volatile int> t82d = val ? s_volatile : s;          // nt_array_ptr<volatile int> and int* _Nt_array OK
  ...
  int* _Array t85 = val ? p_volatile : r;          // expected-warning {{discards qualifiers}}
                                                      // volatile int * and int* _Array produce array_ptr<volatile int>
  int* _Array t86 = val ? r : p_volatile;          // expected-warning {{discards qualifiers}}
                                                      // int* _Array and volatile int * produce array_ptr<volatile int>
  ...
  int* _Array t89 = val ? r : r_volatile;          // expected-warning {{discards qualifiers}}
                                                      // int* _Array and array_ptr<volatile int> produce array_ptr<volatile int>
  int* _Array t90 = val ? r_volatile : r;          // expected-warning {{discards qualifiers}}
                                                      // array_ptr<volatile int> and int* _Array produce array_ptr<volatile int>
  ...
  int* _Array t83a = val ? p : s_volatile;          // expected-warning {{discards qualifiers}}
                                                       // int * and nt_array_ptr<volatile int> produce array_ptr<volatile int>
  int* _Array t84a = val ? s_volatile : p;          // expected-warning {{discards qualifiers}}
                                                       // mt+array_ptr<volatile int> and int * produce array_ptr<volatile int>
  int* _Array t85a = val ? p_volatile : s;          // expected-warning {{discards qualifiers}}
                                                       // volatile int * and int* _Nt_array produce array_ptr<volatile int>
  int* _Array t86a = val ? s : p_volatile;          // expected-warning {{discards qualifiers}}
                                                       // int* _Nt_array and volatile int * produce array_ptr<volatile int>
  int* _Array t87a = val ? p_volatile : s_volatile; // expected-warning {{discards qualifiers}}
                                                       // volatile int * and nt_array_ptr<volatile int> produce array_ptr<volatile int>
  int* _Array t88a = val ? s_volatile : p_volatile; // expected-warning {{discards qualifiers}}
                                                       // nt_array_ptr<volatile int> and volatile int * produce array_ptr<volatile int>
  int* _Array t89a = val ? s : r_volatile;          // expected-warning {{discards qualifiers}}
                                                       // int* _Nt_array and array_ptr<volatile int> produce array_ptr<volatile int>
  int* _Array t90a = val ? r_volatile : s;          // expected-warning {{discards qualifiers}}
                                                       // array_ptr<volatile int> and int* _Nt_array produce array_ptr<volatile int>
  int* _Array t92a = val ? s : r_volatile;          // expected-warning {{discards qualifiers}}
                                                       // nt_array_ptr<volatile int> and array_ptr<volatile int> produce array_ptr<volatile int>
  int* _Array t92b = val ? r_volatile : s_volatile; // expected-warning {{discards qualifiers}}
                                                        // array_ptr<volatile int> and nt_array_ptr<volatile int> produce array_ptr<volatile int>
  int* _Array t92c = val ? s : s_volatile;          // expected-warning {{discards qualifiers}}
                                                       // int* _Nt_array and nt_array_ptr<volatile int> produce array_ptr<volatile int>
  int* _Array t92d = val ? s_volatile : s;          // expected-warning {{discards qualifiers}}
                                                       // nt_array_ptr<volatile int> and int* _Nt_array produce array_ptr<volatile int>
...
int* _Nt_array h8b(void) {
  return checked_global;    // expected-error {{incompatible result type}}
}

int* _Nt_array h8c(void) {
  return nt_checked_global;
}
...
int* _Array h11(int arr checked[10]) {
  return arr;
}

int* _Array h11a(int arr nt_checked[10]) {
  return arr;
}
...
int* _Single h13(int arr checked[10]) {
  return arr;  // ptr<T> = array_ptr<T> OK
}

int* _Single h13a(int arr nt_checked[10]) {
  return arr;  // ptr<T> = nt_array_ptr<T> OK
}

int* _Nt_array h14(int arr checked[10]) {
  return arr;  // expected-error {{incompatible result type}}
}

int* _Nt_array h14a(int arr nt_checked[10]) {
  return arr;
}
...
int* _Array h18(int arr checked[]) {
  return arr;
}

int* _Array h18a(int arr nt_checked[]) {
  return arr;
}
...
void check_pointer_arithmetic(void) {
  ...
  int* _Nt_array s_tmp _Bounds(unknown) = 0;
...
void check_pointer_relational_compare(void) {
  ...
  float* _Single q_float = val_float;
  int* _Single q_int = val_int;
...
void check_cast_operator(void) {
  ...
  int* _Array nt_pax = (int* _Array) &x;
...
extern void check_nt_bounds_safe_interface(const char *interop_string : itype(const char* _Nt_array),
                                           char **interop_ptr : itype(char*_Single*_Nt_array),
