...
extern void f4(int *_Single *_Single p, int y) {
   **p = y;
}

extern void f5(int *_Single *_Single *_Single p, int y) {
   ***p = y;
}
...
extern void g4(int y, int *_Single *_Single p) {
   **p = y;
}

extern void g5(int y, int *_Single *_Single *_Single p) {
   ***p = y;
}
...
extern const int *_Single h3(int y, array_ptr<ptr<const int>> p  _Count(1)) {
   y = **p;
   return *p;
}

extern int *_Single *_Single h4(int y, int *_Single *_Single p) {
   **p = y;
   return p;
}

extern int *_Single *_Single *_Single h5(int y, int *_Single *_Single *_Single p) {
   ***p = y;
   return p;
}
