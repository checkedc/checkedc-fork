...
int (*_Single  array_of_ptr_to_func checked[10])(int x, int  y);
extern int (*_Single array_of_ptr_to_func checked[]) (int x, int  y) ;
int (*_Single aptr2 checked[10])(int x checked[10], int y) ;
int (*_Single aptr3 nt_checked[10])(int x nt_checked[10], int y);

//
// Declaring pointers to arrays and arrays of pointers
//
int (*unchecked_ptr_to_array)checked[5];
int (*_Single ptr_to_array) checked[5] ;
int (*_Single ptr_to_nullterm_array) nt_checked[5] ;
int (*_Array array_ptr_to_array) checked[5] ;
int (*_Array array_ptr_to_nullterm_array) nt_checked[5] ;

int(*unchecked_ptr_to_incomplete_array)checked[];
int (*_Single ptr_to_incomplete_array) checked[] ;
int (*_Single ptr_to_nullterm_incomplete_array) nt_checked[] ;
int (*_Array array_ptr_to_incomplete_array) checked[] ;
int (*_Array array_ptr_to_nullterm_incomplete_array) nt_checked[] ;
...
int *_Single array_of_ptrs checked[5];
int *_Single nullterm_array_of_ptrs nt_checked[5];
int *_Array array_of_array_ptrs checked[5];
int *_Array nullterm_array_of_array_ptrs nt_checked[5];
int *_Nt_array array_of_nullterm_array_ptrs checked[5];
int *_Nt_array nullterm_array_of_nullterm_array_ptrs nt_checked[5];

// Declare an unchecked pointer to checked arrays of pointers
int *(*uncheckedptr_to_array_of_unchecked_ptrs) checked[5];
int * _Single (*unchecked_ptr_to_array_of_ptrs) checked[5];
int *_Array (*unchecked_ptr_to_array_of_array_ptrs) checked[5];
int *_Array (*unchecked_ptr_to_null_term_array_of_array_ptrs) nt_checked[5];

// Declare ptr to checked arrays of pointers
int (*_Single ptr_to_array_of_unchecked_ptrs) checked[5];
int (*_Single *_Single ptr_to_array_of_ptrs) checked[5];
int (*_Array *_Single ptr_to_array_of_array_ptrs) checked[5];
...
int (*_Single *_Single ptr_to_array_of_checked_func_ptrs checked [5])(int x, int y) ;
int (*_Single *_Single ptr_to_nullterm_array_of_checked_func_ptrs nt_checked [5])(int x, int y);
// Make parameter and return types be ptrs too.
int (*_Single *_Single *_Single ptr_to_array_of_checked_func_ptrs_with_ptr_parameters checked[5])(int *_Single  x, int *_Single y);
int (*_Single *_Single *_Single ptr_to_nullterm_array_of_checked_func_ptrs_with_ptr_parameters nt_checked[5])(int* _Single x, int* _Single y);
...
void parse_operators_with_types(void) {
    ...
    int s2 = sizeof(int (*_Single)checked[5]);
    int s3 = sizeof(int (*_Array)checked[5]);
    ...
    int s7 = sizeof(int (*_Single)nt_checked[5]);
    int s8 = sizeof(int (*_Array) nt_checked[5]);
    int s9 = sizeof(int (*_Single) nt_checked[5]);
    int s10 = sizeof(int (*_Array) nt_checked[5]);

    int s20 = _Alignof(int checked[10]);
    int s21 = _Alignof(int (*_Single) checked[5]);
    int s22 = _Alignof(int (*_Single) checked[5]);
    int s23 = _Alignof(int (*_Single) checked[5]);
    int s24 = _Alignof(int (*_Array)checked[5]);
    int s25 = _Alignof(int *_Nt_array checked[5]);

    // null-terminated versions.
    int s26 = _Alignof(int nt_checked[10]);
    int s27 = _Alignof(int (*_Single) nt_checked[5]);
    int s28 = _Alignof(int (*_Array) nt_checked[5]);
    int s29 = _Alignof(int *_Single nt_checked[5]);
